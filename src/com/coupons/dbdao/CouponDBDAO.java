...
/*
 * This class manage all DB requests regarding coupons in the system
 */
...
public class CouponDBDAO implements CouponDAO {
	 ...
	 * @throws ManagerSQLException
	 */
	public boolean isCouponTitleExist(Coupon coupon) throws ManagerThreadException, ManagerSQLException {
	...
	/**
	 * This function looking for coupons that end from the given date and delete them.
	 * @param expirationDate
	 * @throws ManagerSQLException
	 * @throws ManagerThreadException
	 */
	public void removeExpiredCoupon(Date expirationDate) throws ManagerSQLException, ManagerThreadException {
		DateFormat df = new SimpleDateFormat(DATE_FORMAT);
