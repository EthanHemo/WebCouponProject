...
/*
 * ConnectionPool is a singleton that allow object to get connections to the database.
 */
public class ConnectionPool {
	...
	public static ConnectionPool getInstance() throws ManagerSQLException {
		// Check if the instance was initialized. if so he will return the
		// instance.
		if (instance == null) {
	 ...
	 *             - for SQL issues
	 */
	public synchronized Connection getConnection() throws ManagerThreadException, ManagerSQLException {
		...
		if (iterator.hasNext()) {
			...
			throw new ManagerThreadException("Couldn't fetch next connection");
		}
	 ...
	 * @throws ManagerThreadException
	 */
	public synchronized void returnConnection(Connection conn) throws ManagerThreadException {
